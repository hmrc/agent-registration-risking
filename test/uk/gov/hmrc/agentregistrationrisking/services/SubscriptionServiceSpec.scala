...
//extends ISpec:
//
//  val subscriptionService: SubscriptionService = app.injector.instanceOf[SubscriptionService]
...
////
////      val result = subscriptionService.findApprovedReadyToSubscribe.futureValue
...
////      )
////      val result = subscriptionService.getApprovedApplicationsWithIndividuals(Seq(appWithInds))
////      result.size shouldBe 1
////    }
////
...
////        List(Some(List.empty))
////      )
////      val result = subscriptionService.getNonFixableApplicationsWithIndividuals(Seq(appWithInds))
////      result.size shouldBe 1
...
////        List(Some(List.empty))
////      )
////      val result = subscriptionService.getFixableApplicationsWithIndividuals(Seq(appWithInds))
////      result.size shouldBe 1
////      result.headOption.value.individuals shouldBe empty
////    }
////
